...
public class ViewAllListsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TeacherHelper tdh = new TeacherHelper();
		
		List<Teacher> abc = tdh.getLists();
		...
		getServletContext().getRequestDispatcher("/teacher-list-by-user.jsp").forward(request, response);
